...
$function = new Twig_SimpleFunction('load_component_json', function ($component_name) {
  $json = null;
  ...
  $component_json_filename = $pattern_directory . $component_name . '/' . $component_name . '.json';
